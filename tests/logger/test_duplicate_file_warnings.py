...
class TestDuplicateFileWarnings:
    ...
    def test_no_warning_for_single_operation(self, mock_logger, log_manager, mock_file_discovery, capsys):
    ...
    def test_warning_for_overlapping_files(self, mock_logger, log_manager, mock_file_discovery, capsys):
    ...
    def test_no_warning_for_non_overlapping_files(self, mock_logger, log_manager, capsys):
    ...
    def test_multiple_operations_overlapping(self, mock_logger, log_manager, capsys):
    ...
    def test_file_tracking_updates_correctly(self, mock_logger, log_manager):
    ...
    def test_empty_file_list_handling(self, mock_logger, log_manager, capsys):
    ...
    def test_cleanup_removes_file_tracking(self, mock_print, mock_stop_all_hdfs_copy, mock_logger, log_manager):
